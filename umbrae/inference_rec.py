...
# -*- coding: utf-8 -*-
'''
@File    :   inference_rec.py
@Time    :   2024/02/15 23:40:24
@Author  :   Weihao Xia 
@Version :   1.0
@Desc    :   
python inference_rec.py \
    --data_path '/home/wx258/project/nsd_data' --fmri_encoder 'brainx' --subj 1 \
    --brainx_path 'train_logs/brainx.pth' \
    --save_path 'evaluation/eval_bbox_rec/rec_results/brainx_sub01_dim1024'
'''
